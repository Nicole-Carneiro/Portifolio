import svgPaths from "./svg-d7889dxhq3";
import imgMtsPosters21 from "./7ed970ffbaaee7e01784995b77bbd1df05b96291.png";
import imgPilhaPapeis1 from "./a3a7e14dae7f339dd67df88a5ec9c94dff0309ea.png";
import imgVector from "./72441e19fca743db7502d8a8c73de6d530e39a08.png";
...
export default function Project() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[32px] items-center relative size-full" data-name="Project3">
      <Frame12 />
      <Frame2 />
