import svgPaths from "./svg-hk2w29o2u8";
import imgWhatsAppImage20260424At15024241 from "./005a8ad276a8e97582b873b2a66156d8cbe4659d.png";
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[24px] items-center leading-[normal] relative shrink-0 text-[24px] text-black whitespace-nowrap">
      <p className="font-['Rethink_Sans:Regular',sans-serif] font-normal relative shrink-0">proyectos</p>
      <p className="font-['Rethink_Sans:SemiBold',sans-serif] font-semibold relative shrink-0">sobre mí</p>
    </div>
  );
}
    ...
    <div className="content-stretch flex flex-col gap-[10px] items-start relative rounded-[16px] shrink-0 text-[#817f7f] text-[14px] w-full">
      ...
      <div className="font-['Rethink_Sans:Regular',sans-serif] font-normal leading-[0] relative shrink-0 w-full">
        ...
        <p className="leading-[normal]">
          ...
          <br aria-hidden="true" />a passion for creativity, I create and tell stories through images. I value the sensitivity of hand-made work
          <br aria-hidden="true" />
...
function Mail() {
  return (
    <div className="relative shrink-0 size-[36px]" data-name="mail">
      <div className="absolute inset-[-3.89%_-15%_-15%_-3.89%]">
...
export default function SobreMi() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="Sobre mi">
      <Frame2 />
      <Frame3 />
    </div>
  );
